...
- Internal issue-tracker IDs or slugs (e.g. Linear `SAA-84`, Jira keys, private board names)
- Cloud-agent or machine paths (e.g. `/opt/cursor/...`, home-directory scratch paths)
